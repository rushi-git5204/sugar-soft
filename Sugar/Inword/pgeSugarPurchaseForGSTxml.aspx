...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function pagevalidation() {
            ...
            var CreditNarration = MillShortName + "L:" + LORRYNO + "G:" + Grade + " " + Quntal + " R:" + gridView.rows[1].cells[9].innerHTML;
            var DebitNarration = MillShortName + " " + PartyShortName + "L:" + LORRYNO + "G:" + Grade + " " + Quntal + " R:" + gridView.rows[1].cells[9].innerHTML;
            var TCSNarration = 'TCS' + PartyShortName + " " + Doc_No;
            var TDSNarration = 'TDS' + PartyShortName + " " + Doc_No;
            var Order_Code = 1;
