...
public partial class Sugar_Master_PgeDoHeadUtility : System.Web.UI.Page
{
    ...
    private void BindDummyRow()
    {
        ...
        dummy.Columns.Add("vasuli_rate1");
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, string Trantype1, int PageSize, int Company_Code, int year)
    {
        ...
        //             "transport.Short_Name AS transportshortname, dbo.nt_1_deliveryorder.mill_rate, dbo.nt_1_deliveryorder.MM_Rate, dbo.nt_1_deliveryorder.vasuli_rate1 " +
        //             "FROM         dbo.nt_1_citymaster AS salebillcity RIGHT OUTER JOIN " +
        //             "dbo.nt_1_accountmaster AS salebillto ON salebillcity.cityid = salebillto.cityid RIGHT OUTER JOIN " +
        //             "dbo.nt_1_deliveryorder ON salebillto.accoid = dbo.nt_1_deliveryorder.sb LEFT OUTER JOIN " +
        //             "dbo.nt_1_accountmaster AS transport ON dbo.nt_1_deliveryorder.tc = transport.accoid LEFT OUTER JOIN " +
        ...
        if (Trantype == "AI")
        {
            ...
            else
            {
                query = "SELECT ROW_NUMBER() OVER ( order by doc_no ASC) AS RowNumber,dbo.nt_1_deliveryorder.doc_no, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, 103) AS doc_date, " +
                     ...
                     "dbo.nt_1_accountmaster AS mill ON dbo.nt_1_deliveryorder.mc = mill.accoid LEFT OUTER JOIN " +
                     "dbo.nt_1_citymaster AS shiptocity ON shipto.cityid = shiptocity.cityid where " + name + " and dbo.nt_1_deliveryorder.company_code=" + Company_Code + " " +
                     " and dbo.nt_1_deliveryorder.desp_type='" + Trantype + "' and dbo.nt_1_deliveryorder.Delivery_Type='" + Trantype1 + "'  and dbo.nt_1_deliveryorder.Year_Code=" + year + " order by  dbo.nt_1_deliveryorder.doc_no desc";
            }
        }
        else if (Trantype == "DI")
        {
            if (Trantype1 == "AI")
            {
                query = "SELECT ROW_NUMBER() OVER ( order by doc_no ASC) AS RowNumber,dbo.nt_1_deliveryorder.doc_no, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, 103) AS doc_date, " +
                   ...
                   "dbo.nt_1_accountmaster AS mill ON dbo.nt_1_deliveryorder.mc = mill.accoid LEFT OUTER JOIN " +
                   "dbo.nt_1_citymaster AS shiptocity ON shipto.cityid = shiptocity.cityid where " + name + " and dbo.nt_1_deliveryorder.company_code=" + Company_Code + " " +
                   " and dbo.nt_1_deliveryorder.desp_type='" + Trantype + "' and dbo.nt_1_deliveryorder.purc_no!='0'  and dbo.nt_1_deliveryorder.Year_Code=" + year + " order by  dbo.nt_1_deliveryorder.doc_no desc";
            }
            else
            {
                query = "SELECT ROW_NUMBER() OVER ( order by doc_no ASC) AS RowNumber,dbo.nt_1_deliveryorder.doc_no, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, 103) AS doc_date, " +
                   ...
                   "dbo.nt_1_accountmaster AS mill ON dbo.nt_1_deliveryorder.mc = mill.accoid LEFT OUTER JOIN " +
                   "dbo.nt_1_citymaster AS shiptocity ON shipto.cityid = shiptocity.cityid where " + name + " and dbo.nt_1_deliveryorder.company_code=" + Company_Code + " " +
                   " and dbo.nt_1_deliveryorder.desp_type='" + Trantype + "' and dbo.nt_1_deliveryorder.purc_no!='0' and dbo.nt_1_deliveryorder.Delivery_Type='" + Trantype1 + "' and dbo.nt_1_deliveryorder.Year_Code=" + year + " order by  dbo.nt_1_deliveryorder.doc_no desc";
            }
        }
        else if (Trantype == "DO")
        {
        ...
        else
        {
            if (Trantype1 == "AI")
            {
                 query = "SELECT ROW_NUMBER() OVER ( order by doc_no ASC) AS RowNumber,dbo.nt_1_deliveryorder.doc_no, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, 103) AS doc_date, " +
                     ...
                     "dbo.nt_1_accountmaster AS mill ON dbo.nt_1_deliveryorder.mc = mill.accoid LEFT OUTER JOIN " +
                     "dbo.nt_1_citymaster AS shiptocity ON shipto.cityid = shiptocity.cityid where " + name + " and dbo.nt_1_deliveryorder.company_code=" + Company_Code + " " +
                     "  and dbo.nt_1_deliveryorder.purc_no='0' and dbo.nt_1_deliveryorder.Year_Code=" + year + " order by  dbo.nt_1_deliveryorder.doc_no desc";
            }
            else
            {
                query = "SELECT ROW_NUMBER() OVER ( order by doc_no ASC) AS RowNumber,dbo.nt_1_deliveryorder.doc_no, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, 103) AS doc_date, " +
                    ...
                    "dbo.nt_1_accountmaster AS mill ON dbo.nt_1_deliveryorder.mc = mill.accoid LEFT OUTER JOIN " +
                    "dbo.nt_1_citymaster AS shiptocity ON shipto.cityid = shiptocity.cityid where " + name + " and dbo.nt_1_deliveryorder.company_code=" + Company_Code + " " +
                    " and dbo.nt_1_deliveryorder.purc_no='0' and dbo.nt_1_deliveryorder.Delivery_Type='" + Trantype1 + "' and dbo.nt_1_deliveryorder.Year_Code=" + year + " order by  dbo.nt_1_deliveryorder.doc_no desc";
            }
        }
