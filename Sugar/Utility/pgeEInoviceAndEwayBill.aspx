<%@ Page Title="pgeEInoviceAndEwayBill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeEInoviceAndEwayBill.aspx.cs" Inherits="Sugar_Utility_pgeEInoviceAndEwayBill" %>
            ...
            <table width="80%" align="left">
                <tr>
                    <td align="center">
                        ...
                        &nbsp;
                        <asp:Button ID="btnGenEwayBill" runat="server" Text="Generate EInvoice & EwayBill" CssClass="btnHelp"
                            Width="200px" ValidationGroup="save" OnClick="btnGenEwayBill_Click" Height="24px" />
                    ...
                    <tr>
                        <td align="left">Document No
                            <asp:TextBox Height="24px" ID="txtDoc_No" runat="Server" CssClass="txt" TabIndex="5"
                                Width="135px" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtDoc_No_TextChanged"></asp:TextBox>
