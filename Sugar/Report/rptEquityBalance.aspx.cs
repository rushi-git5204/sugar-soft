...
public partial class Sugar_Report_rptEquityBalance : System.Web.UI.Page
{
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquityBalance where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + "and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + "", con);
