    ...
    protected void btnWhatsApp_Click(object sender, EventArgs e)
    {
        ...
        if (table.Rows.Count > 0)
        {
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                string message = " HI " + Environment.NewLine + " PAYMENT DETAIL FROM NAVKAR TRADERS" + Environment.NewLine +
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "api-call", "javascript:sendPdfToWatsapp('" + bill_no + "','" + base64String + "', '" + uploadedFileName + "','" + instanceid + "','" + accesstoken + "','PAYMENT DETAIL FROM NAVKAR TRADERS','" + Moblie_Number + "', 'LATASOFTWARE','" + txtWhatsapp.Text + "');", true);
