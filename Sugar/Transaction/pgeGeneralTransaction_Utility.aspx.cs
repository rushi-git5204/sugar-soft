...
public partial class Sugar_Transaction_pgeGeneralTransaction_Utility : System.Web.UI.Page
{
    ...
    private void BindDummyRow()
    {
        ...
        dummy.Columns.Add("Company_Name_E");
        dummy.Columns.Add("year");
        dummy.Columns.Add("DebitAc_Name");
        dummy.Columns.Add("CreditAc_NAme");
        dummy.Columns.Add("amount");
        dummy.Columns.Add("narration");
        dummy.Columns.Add("gtranid");
    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( Company_Name_E like '%" + aa + "%' or year like '%" + aa + "%' or doc_no like '%" + aa + "%' or doc_dateConverted like '%" + aa + "%' or DebitAc_Name like '%" + aa + "%'  or CreditAc_NAme like '%" + aa + "%' or amount like '%" + aa + "%' or narration like '%" + aa + "%' ) and";
       ...
       + "Company_Name_E ,year,DebitAc_Name,CreditAc_NAme,amount,narration,gtranid FROM qryGeneralTrasaction   where " + name + " and Company_Code=" + Company_Code + " " +
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       ...
       + "Company_Name_E ,year, DebitAc_Name,CreditAc_NAme,amount,narration,gtranid FROM " + qryCommon + " limit 15";
