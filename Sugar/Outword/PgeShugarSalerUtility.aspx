<%@ Page Language="C#" Title="U-SaleReturn" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeShugarSalerUtility.aspx.cs" Inherits="Sugar_Master_PgeShugarSalerUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Outword/PgeShugarSalerUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(5).html($(this).find("srid").text());
                    $("td", row).eq(6).html($(this).find("ackno").text());
                    $("td", row).eq(7).html($(this).find("Eway_Bill_No").text());
                    $("td", row).eq(8).html($(this).find("IsDeleted").text());
            ...
            $('#gvCustomers  tr').each(function () {
                debugger;
                var number = $(this).children('td:eq(8)').text();
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                var Action = 1;
                var srid = tableData[5];
                if (row_index > 0) {
                    if (isNaN(srid)) {
                    }
                    else {
                        window.open('../Outword/pgeSugarsaleReturnForGST.aspx?srid=' + srid + '&Action=' + Action);
                    }
                }
            });
    ...
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Label ID="Label2" runat="server" Text="Entries" Font-Bold="True"
                ForeColor="#CC3300" Font-Size="Medium"></asp:Label>
            <asp:Button ID="btnAdd" runat="server" Text="Add New" class="btnHelp" OnClientClick="SugarSale()"
                ValidationGroup="save" Width="90px" Height="24px" OnClick="btnAdd_Click" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; 
           
            <asp:Label ID="lblUtilityName" runat="server" Text="Sugar Sale Return Sale" Font-Bold="True"
           ...
           <asp:Label ID="Label3" runat="server" Text="Search:" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1500px"
                    ...
                    <Columns>
                        <asp:BoundField HeaderStyle-Width="20px" DataField="doc_no" HeaderText="Doc No"
                            ItemStyle-CssClass="doc_no" ControlStyle-BackColor="#ff0066" FooterStyle-BorderWidth="15" FooterStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="doc_date" HeaderText="Date" AccessibleHeaderText="center" />
                        <asp:BoundField HeaderStyle-Width="150px" DataField="Ac_Name_E" HeaderText="Account Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="NETQNTL" HeaderText="Net Quantail" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Bill_Amount" HeaderText="Bill Amount" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="srid" HeaderText="SrID" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="ackno" HeaderText="ACKNo" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="Eway_Bill_No" HeaderText="EwayBill No" />
